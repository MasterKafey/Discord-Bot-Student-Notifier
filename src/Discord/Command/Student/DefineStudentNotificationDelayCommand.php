...
class DefineStudentNotificationDelayCommand extends AbstractDiscordCommand
{
    ...
    {
        return 'set-student-notification-delay';
    }
    ...
    public function getOptions(): array
    {
        return [
            ...
            [
                'name' => 'day',
                'required' => true,
                'description' => 'Nombre de jours entre chaque notification',
                'type' => Option::NUMBER,
            ]
        ];
    }
    ...
    {
        return 'Définie le nombre de jours entre chaque notification';
    }
    ...
    public function execute(Interaction $interaction): ?PromiseInterface
    {
        ...
        $student->setIntervalNotification(new \DateInterval('P' . $dayNumber . 'D'));
        $this->entityManager->persist($student);
        $this->entityManager->flush();

        return $interaction->respondWithMessage(MessageBuilder::new()->setContent("Le nombre de jours entre chaque notification est défini à $dayNumber"));
    }
}